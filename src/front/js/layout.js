...
import PaymentSuccessPage from "./component/Paypal/OnSuccess.jsx";
import DisplayTickets from "./pages/Tickets/TicketsPage.jsx";
      ...
      <BrowserRouter basename={basename}>
        <ScrollToTop>
          ...
          <Routes>
            ...
            <Route
              element={<ShowProductPageFiltered />}
            ...
            <Route
              ...
              path="/userProfile/:theid/settings"
            />
            <Route
              element={<UserPassword />}
              path="/userProfile/:theid/change_password"
            />
            <Route
              element={<DeleteUserAccount />}
              path="/userProfile/:theid/delete_account"
            />
            <Route
              element={<ProductDetailPage />}
              path="/product/:theid/detail_page"
            />
            <Route
            ...
            <Route element={<DisplayTickets />} path="/user/:theid/tickets"/>
