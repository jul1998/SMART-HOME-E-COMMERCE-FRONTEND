...
function UserSettings(){
    ...
    useEffect(() => {
      ...
      async function handleChangeUserInfo(event){
        ...
        //console.log(bodyObj)
        let response = await actions.genericFetchProtected(`user/${params.theid}/settings`, "PUT", bodyObj)
        let jsonRes = await response.json()
        console.log(jsonRes)
    ...
    return(
        <div className="userSettings-main">
            <h2>In this section, you cange your personal information</h2>
  ...
  <div className="mb-3">
    ...
    <input onChange={handleChange} name="fullname" type="text" className="form-control" id="exampleInputName"/>
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputAddress" className="form-label">Address</label>
    <input onChange={handleChange} name="address" type="text" className="form-control" id="exampleInputAddress"/>
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputPhone" className="form-label">Phone number</label>
    <input onChange={handleChange} name="phone" type="tel" className="form-control" id="exampleInputPhone"/>
  </div>
  <div className="mb-3">
    <label htmlFor="exampleInputImg" className="form-label">Profile image</label>
    <input onChange={handleChange} name="img" type="text" className="form-control" id="exampleInputImg"/>
  </div>
  <button type="submit" className="btn btn-primary">Change my information</button>
</form>
        </div>
    )
}
